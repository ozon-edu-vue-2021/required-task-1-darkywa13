...
const templateImageCard = document.querySelector("#tpl-image");
const templateImagePopup = document.querySelector("#tpl-popup-image");
...
const renderPopupPicture = function(picture) {
  ...
  const link = clone.querySelector("a");
  const author = clone.querySelector(".popup-image__author");

  img.src = cropImage(picture.download_url);
